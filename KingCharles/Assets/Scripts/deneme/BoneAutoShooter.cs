...
{
    [Header("Kemik Atış Ayarları")]
    public GameObject bonePrefab;   // Fırlatılacak kemik prefabı
    public Transform firePoint;     // Kemiğin çıkacağı nokta
    public float attackRange = 15f; // En yakındaki düşmanı bu mesafe içinde arayacak
        ...
        for (int i = 0; i < totalProjectiles; i++)
        {
            ...
            if (proj != null)
            {
                ...
                if (WeaponChoiceManager.Instance != null)
                {
                    ...
                    proj.damage = modified; // Artık component'in damage field'i de buff’lı
...
/// <summary>
/// Sahnede aynı anda en fazla N BoneProjectile görünsün ve ses çıkarsın.
...
public class BoneProjectileVisibilityLimiterToken : MonoBehaviour
{
    ...
    private void Update()
    {
        // Her zaman oyuncuya en yakın 10 tane görünsün diye periyodik refresh
    ...
    private static void RefreshAll()
    {
        ...
        // player yoksa sıralama yapma → eski oluşma sırası kalır
